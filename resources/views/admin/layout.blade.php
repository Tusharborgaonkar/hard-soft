...
<body>
    <div class="sidebar">
        ...
        <nav class="nav">
            ...
            <a href="{{ route('admin.result-report') }}" class="nav-item {{ request()->is('admin/result-report') ? 'active' : '' }}">Result Report</a>
            <a href="{{ route('admin.report') }}" class="nav-item {{ request()->is('admin/report') ? 'active' : '' }}">Detailed Print</a>
