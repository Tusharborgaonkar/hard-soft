...
<form action="{{ route('admin.questions.store') }}" method="POST">
    ...
    <div class="card" style="margin-bottom: 2rem;">
        ...
        <div id="reason-label-container" style="margin-top: 1.5rem; display: none; border: 1px solid var(--border); padding: 1.25rem; border-radius: 8px; background: #fdfdfd;">
            <div style="margin-bottom: 1rem;">
            ...
            <div>
                ...
                <input type="text" name="meta_params[reason_trigger]" placeholder="e.g. હા (Leave blank to always show)" style="width:100%; padding:0.75rem; border:1px solid var(--border); border-radius:8px;">
