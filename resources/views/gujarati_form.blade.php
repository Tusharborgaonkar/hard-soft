        ...
        <form id="questionnaireForm" 
            ...
            <div class="form-step {{ $index === 0 ? 'active' : '' }}" id="step{{ $index }}">
                ...
                <div class="form-group">
                    ...
                    @if($q->meta_params['has_reason'] ?? false)
                        <div style="margin-top: 1.5rem; padding-top: 1rem; border-top: 1px dashed #e5e7eb;">
                            ...
                            <input type="text" name="q_{{ $q->id }}_reason" value="{{ $editData['q_'.$q->id.'_reason'] ?? '' }}" placeholder="Enter reason here..." style="width:100%; padding:0.8rem 1rem; border:1.5px solid var(--input-border); border-radius:var(--radius-sm); font-family:inherit; font-size:0.95rem; transition:border-color 0.2s; outline:none;" onfocus="this.style.borderColor='var(--primary)'" onblur="this.style.borderColor='var(--input-border)'">
                        </div>
                    @endif
                </div>
